...
Page({
  ...
  onLoad: function (options) {
    this.getGoodDetial(options.id || 24);
    this.getList(options.id || 24);
  },
  onShow: function () {
  ...
  updateZan: function () {
    ...
    let that = this;
    util.getDataByAjax({
      url: '/api/good/rentgood/zan',
      method: "Post",
      preventSubmits: true,
      data: {
        userId: wx.getStorageSync("userId"),
        rentgoodId: that.data.good.id,
      },
  ...
  submitComment: function () {
    ...
    let that = this;
    util.getDataByAjax({
      url: '/api/good/rentgood/comment/add',
      method: "Post",
      preventSubmits: true,
      data: {
        userId: wx.getStorageSync("userId"),
  ...
  getList: function (id) {
    let that = this;
    util.getDataByAjax({
      url: '/api/good/rentgood/comment/get',
      method: "Get",
      data: {
